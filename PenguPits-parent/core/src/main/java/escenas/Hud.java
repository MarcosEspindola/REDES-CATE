...
import utiles.Global; // Necesario para acceder a las texturas
...
public class Hud {
    ...
    public Hud() {
        ...
        // *** CORRECCIÓN CRÍTICA: Usar Texturas pre-cargadas ***
        for (int i = 0; i < 5; i++) {
            // Creamos las Imagenes usando las Texturas ya cargadas globalmente
        ...
        actual1 = 0; // 5 vidas = índice 0
        actual2 = 0; // 5 vidas = índice 0
    }
